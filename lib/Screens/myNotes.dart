...
import 'package:mdpflutterproject/Services/dbOperations.dart';
import 'package:mdpflutterproject/main.dart';
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          leading: TextButton(
            ...
            child: Text(
              "Log out",
              style: GoogleFonts.oswald(fontSize: 10, color: Color.fromARGB(255, 255, 255, 255)),
            ),
          ),
        ),
        body: _getTasks(),
        floatingActionButton: FloatingActionButton(
          onPressed: () => _displayDialog(context, "Add Note", () {
            ...
            content: TextField(
              ...
              decoration: InputDecoration(
                  ...
                  hintStyle: GoogleFonts.oswald(
                      ...
                      color: Color.fromARGB(179, 131, 131, 131))),
            ),
            actions: [
